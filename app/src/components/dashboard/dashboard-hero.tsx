...
export function DashboardHero() {
  return (
    <section className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-[linear-gradient(135deg,rgba(16,23,37,0.96),rgba(8,12,21,0.94))] px-5 py-7 shadow-[0_24px_80px_rgba(2,6,18,0.4)] sm:rounded-[2rem] sm:px-8 sm:py-10">
      ...
      <div className="relative flex flex-col gap-5">
        ...
        <div className="space-y-3">
          <h2 className="text-[2rem] font-semibold tracking-[-0.04em] text-white sm:text-[2.7rem]">
            Welcome back
          </h2>
