...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    ...
    >
      ...
      <section className="relative z-20 mx-auto grid min-h-svh w-full max-w-[1450px] items-center gap-10 px-5 py-14 sm:px-8 lg:grid-cols-[minmax(0,1fr)_minmax(440px,630px)] lg:gap-16 lg:px-10 xl:gap-24">
        ...
        <div className="relative z-20 ml-auto w-full max-w-[630px]">
          ...
          <div className="relative overflow-hidden rounded-[1.7rem] border border-[#8b5cf6]/58 bg-[linear-gradient(135deg,rgba(31,27,58,0.985),rgba(21,20,43,0.988)_48%,rgba(27,24,49,0.985))] px-6 py-8 shadow-[0_38px_130px_rgba(0,0,0,0.78),0_0_90px_rgba(139,92,246,0.24)] backdrop-blur-xl sm:px-10 sm:py-11 lg:px-12">
            <Link
              href="/"
            ...
            <div className="relative">
              <div className="mb-9 space-y-3.5 pr-10">
                <h2
                  className={cn(
                ...
                <p className="max-w-[29rem] text-[0.95rem] font-medium leading-6 text-[#b8c1ec]">
                  Enter your account and continue building your olYmpos.
                </p>
              </div>
              ...
              <form action={login} className="space-y-6">
                ...
                <div className="flex flex-col gap-3 text-sm font-medium text-[#b8c1ec] sm:flex-row sm:items-center sm:justify-between">
                  <label className="flex cursor-pointer items-center gap-2.5 transition hover:text-[#eadcff]">
                    <input
                      type="checkbox"
                      className="login-checkbox h-4 w-4 rounded-[3px] border border-[#8b5cf6]/45 !bg-[#05050a] hover:!bg-[#05050a] checked:border-[#8b5cf6] checked:!bg-[#05050a] focus:!bg-[#05050a] focus:ring-2 focus:ring-[#8b5cf6]/50"
                    />
                    <span>Remember me</span>
                  </label>
                  <Link href="/login" className="!text-[#9a72ff] transition hover:!text-[#c4b5fd]">
                    Forgot password?
                  </Link>
                </div>
                ...
                <p className="pt-7 text-center text-sm font-medium text-[#b8c1ec]">
                  Don&apos;t have an account?{" "}
                  <Link href="/signup" className="!text-[#9a72ff] transition hover:!text-[#c4b5fd] hover:underline hover:decoration-dashed hover:underline-offset-4 hover:[text-decoration-style:dashed]">
                    Sign Up
                  </Link>
                </p>
              </form>
